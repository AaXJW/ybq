...
<%@ include file="/WEB-INF/jsp/taglibs.jsp" %>
    <title>素质能力结果录入</title>
    <h2 align="center">素质能力录入</h2>
  		<form action="${ctx}/QualityAbility/saveQualityAbilityResult.htm" method="post" name="inputForm" id="inputForm"  enctype="multipart/form-data"
		...
		<%-- 	    <div id="recommendertelCT" class="row form-group">
	  			...
	  			<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">分数</span>
					  <input type="text" class="form-control" id="qaFraction" name="qaFraction" placeholder="请输入分数" value="${qaFraction }"
	  				...
	  				<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">分析</span>
					  <input type="text" class="form-control" id="qaAnalysis" name="qaAnalysis" placeholder="请输入结果分析" value="${qaAnalysis }"
	  				...
	  				<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">学习</span>
					  <input type="text" class="form-control" id="qaStudy" name="qaStudy" placeholder="请输入学习方案" value="${qaStudy }"
						required data-bv-notempty-message="题目不能为空" aria-describedby="basic-addon3">
	  				...
	  				<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">建议</span>
					  <input type="text" class="form-control" id="qaProposal" name="qaProposal" placeholder="请输入方向建议" value="${qaProposal }"
						required data-bv-notempty-message="题目不能为空" aria-describedby="basic-addon3">
	  			...
	  			<div id="enableCT" class="row form-group">
					<div class="input-group">
						<span class="input-group-addon">素质类型</span> <select
