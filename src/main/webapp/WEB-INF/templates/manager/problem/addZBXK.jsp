...
<%@ include file="/WEB-INF/jsp/taglibs.jsp" %>
    <title>走班选科录入</title>
    <h2 align="center">走班选科录入</h2>
  		<form action="${ctx}/ZBXK/save.htm" method="post" name="inputForm" id="inputForm"  enctype="multipart/form-data"
		...
		<%-- 	    <div id="recommendertelCT" class="row form-group">
	  			...
	  			<div id="nameCT" class="row form-group">
					  ...
					  <input type="text" class="form-control" id="zbxkNumber" name="zbxkNumber" placeholder="请输入编号" value="${zbxkNumber }"
					  ...
					  <input type="text" class="form-control" id="zbxkProblem" name="zbxkProblem" placeholder="请输入题目" value="${zbxkProblem }"
	  			...
	  			<div id="enableCT" class="row form-group">
					<div class="input-group">
						<span class="input-group-addon">选科类型</span> <select
							class="form-control" title="请选择一个问题" name="zbxkType" id="zbxkType">
							<option value="WL">物理类型</option>
							<option value="LS">历史类型</option>
							<option value="HX">化学类型</option>
							<option value="SW">生物类型</option>
							<option value="DL">地理类型</option>
							<option value="ZZ">政治类型</option>
