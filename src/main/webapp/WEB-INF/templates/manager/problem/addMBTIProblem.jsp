...
<%@ include file="/WEB-INF/jsp/taglibs.jsp" %>
    <title>MBTI测试录入</title>
    <h2 align="center">MBTI测试录入</h2>
  		<form action="${ctx}/MBTIProblem/save.htm" method="post" name="inputForm" id="inputForm" 
		...
		<%-- 	    <div id="recommendertelCT" class="row form-group">
	  			...
	  			<div id="telDiv" class="row form-group">
	  				<div id="telCT" >
		  				<div class="input-group">
		  				<span class="input-group-addon" id="basic-addon2">题目</span>
						  <textarea type="text" class="form-control" id="problem" name="problem" placeholder="请输入题目" value="${problem}"
							required data-bv-notempty-message="题目不能为空" aria-describedby="basic-addon2"
							data-bv-phone="true" data-bv-phone-country="CN" data-bv-phone-message="输入不是有效的手机号 " data-bv-threshold="11"
						  data-bv-remote="true" ></textarea>
						</div>
					</div>
	  			</div>
	  			...
	  			<div id="nameCT" class="row form-group">
					  ...
					  <input type="text" class="form-control" id="number" name="number" placeholder="请输入编号" value="${number }"
	  			...
	  			<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">A选项</span>
					  <input type="text" class="form-control" id="resultA" name="resultA" placeholder="请输入A选项" value="${resultA }"
						required data-bv-notempty-message="编号不能为空" aria-describedby="basic-addon3">
	  				...
	  				<div id="nameCT" class="row form-group">
	  				<div class="input-group">
	  				<span class="input-group-addon" id="basic-addon3">B选项</span>
					  <input type="text" class="form-control" id="resultB" name="resultB" placeholder="请输入B选项" value="${resultB }"
						required data-bv-notempty-message="编号不能为空" aria-describedby="basic-addon3">
