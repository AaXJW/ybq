...
<%@ include file="/WEB-INF/jsp/taglibs.jsp" %>
    <title>后台系统录入</title>
    <h2 align="center">后台系统录入</h2>
  		<form action="${ctx}/Article/login.htm" method="post" name="inputForm" id="inputForm" 
	  			...
	  			<div id="telDiv" class="row form-group">
	  				<div id="telCT" >
						  ...
						  <input type="text" class="form-control" id="userName" name="userName" placeholder="请输入用户名" value="${userName}"
							required data-bv-notempty-message="用户名不能为空" aria-describedby="basic-addon2"
